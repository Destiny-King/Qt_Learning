...
DeviceButton::DeviceButton(QWidget *parent) : QWidget(parent)
{
    ...
    type = "police";
    imgName = QString(":/images/devicebutton/devicebutton_green_%1.png").arg(type);
    isDark = false;
...
{
    if(isDark){
        imgName = QString(":/images/devicebutton/devicebutton_black_%1.png").arg(type);
    }else{
        imgName = QString(":/images/devicebutton/devicebutton_red_%1.png").arg(type);
    }
...
void DeviceButton::setButtonColor(const DeviceButton::ButtonColor &buttonColor)
{
    ...
    if(buttonColor == ButtonColor_Green){
        ...
        imgName = QString(":/images/devicebutton/devicebutton_blue_%1.png").arg(type);
    } else if (buttonColor == ButtonColor_Gray) {
        imgName = QString(":/images/devicebutton/devicebutton_gray_%1.png").arg(type);
    } else if (buttonColor == ButtonColor_Black) {
        imgName = QString(":/images/devicebutton/devicebutton_black_%1.png").arg(type);
    } else if (buttonColor == ButtonColor_Purple) {
        imgName = QString(":/images/devicebutton/devicebutton_purple_%1.png").arg(type);
    } else if (buttonColor == ButtonColor_Yellow) {
        imgName = QString(":/images/devicebutton/devicebutton_yellow_%1.png").arg(type);
